...
public abstract class SkeletonMixin extends Monster implements DancingMob {
	@Unique
	private static final EntityDataAccessor<Boolean> JAMMIES_DANCING = SynchedEntityData.defineId(AbstractSkeleton.class, EntityDataSerializers.BOOLEAN);

	@Unique
	public final AnimationState jammies$spookyState = new AnimationState();
